...
import profileImg from '../../assets/landlord-profile-img.png';
import translate from '../../assets/translate.png';
import marker from '../../assets/marker.png';
import checkMark from '../../assets/check-mark.png';
import tenentProfile from '../../assets/tenent-profile.png';
import star from '../../assets/star-filled.png';
import listingImg from '../../assets//listing-img.png';
import favoriteIcon from '../../assets/favorite.png';
import bedIcon from '../../assets/Bed.png';
import bathroomIcon from '../../assets/Bath.png';
import squareMeterIcon from '../../assets/Square-Meters.png';
const AboutLandlord = () => {
return (
<div>
<div className="my-12">
<div className="bg-[#eef1f3]">
<div className="lg:w-[1216px] mx-auto lg:flex inline lg:py-[80px] py-12 gap-x-10 px-4 lg:px-0">
<div><img className="w-[104px] h-[104px] rounded-full" src={profileImg} alt="" /></div>
...
<div className='lg:flex  w-1/2  lg:gap-4 gap-2'>
<div className='bg-[#eef1f3] rounded px-4 py-2 flex gap-x-2'>
<img src={checkMark} alt="" /> <p>Identity</p>
</div>
<div className='bg-[#eef1f3] rounded px-4 py-2 flex gap-x-2'>
<img src={checkMark} alt="" /> <p>Email address</p>
</div>
<div className='bg-[#eef1f3] rounded px-4 py-2 flex gap-x-2'>
<img src={checkMark} alt="" /> <p>Phone number</p>
</div>
</div>
</div>
</div>
...
<div className='lg:grid lg:grid-cols-3 grid-cols-1 lg:gap-6 gap-3 mt-12 lg:p-0 p-4 '>
<div className='p-6 grid grid-cols-1 gap-y-5 bg-white rounded-[20px] border border-[#c4c6c9]/60 shadow-custom'>
<div className='flex gap-x-4 items-center'>
<div><img src={tenentProfile} alt="" /></div>
